  ...
  util = {
    ...
    $a5: function (t, e) {
      ...
      for (var r, n = [], i = 0, o = e.length; i < o; i++)
        if (((r = e[i]), this.isString(r)))
          n.push(r.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, '\\$1'))
        else if (r && r.source) n.push(r.source)
        else if (r && 'Function' === this.T(r) && !0 === this.$a3(r, [t], !1))
          return !0
    ...
    off: function (t, e, r) {
      return r
        ? (t.removeEventListener
            ...
            : t.detachEvent && t.detachEvent(e, r),
          this)
        : this
    },
    delay: function (t, e) {
    ...
    serialize: function (t) {
      ...
      for (var r in t)
        Object.prototype.hasOwnProperty.call(t, r) &&
          t[r] !== undefined &&
          e.push(r + '=' + this.encode(t[r], 'msg' === r))
      return e.join('&')
    },
    $a7: function (t, e) {
      ...
      return (
        !r && e && (r = /(\.png)|(\.gif)|(alicdn\.com)|(mmstat\.com)/.test(t)),
        !r
      )
    },
    $a8: function (t) {
    ...
    getQuerys: function (t) {
      ...
      try {
        ...
        if (
          (t.indexOf('?') >= 0 &&
            (o = t.substring(t.indexOf('?') + 1, t.length).split('&')),
          o.length > 0)
        )
          for (var a in o)
            (n = (r = o[a].split('='))[0]), (i = r[1]), (e[n] = i)
      } catch (s) {
        e = {}
      }
      return e
    ...
    getXhrSnapshot: function (t, e, r) {
      ...
      try {
        var o = ''
        '' === r.responseType || 'text' === r.responseType
          ? (o = r.responseText)
          : 'document' === r.responseType && (o = r.responseXML),
          (n = {
            originApi: t,
            method: e,
            ...
            resHeaders: this.parseXhrHeaders(
              ('function' == typeof r.getAllResponseHeaders &&
    ...
    isRobot: function () {
      ...
      try {
        for (
          var e = navigator.userAgent.toLowerCase(), r = 0;
          r < t.length;
          r++
        ) {
          var n = t[r]
    ...
    $ae: function (t, e, r) {
      ...
      try {
        n = this.isPlainObject(t)
          ? this.ext(
              { key: t.key || 'default', val: t.val || t.value || r },
              t,
              { begin: Date.now() }
            )
...
;(Base.dftCon = {
  ...
  (Base.prototype = {
    ...
    setCommonInfo: function (t) {
      t &&
        'object' == typeof t &&
        (this._common = util_1.ext({}, this._common, t))
    },
    $al: function () {
    ...
    getUberTraceId: function (t) {
      ...
      return (
        (t = t ? '1' : '0'),
        { 'uber-trace-id': o + ':' + a + ':0:' + t, traceId: o }
      )
    },
    ...
    $au: function (t) {
      return (
        1 === t ||
        ('boolean' == typeof this.$aj[t]
          ? this.$aj[t]
          : ((this.$aj[t] = util_1.pick(t)), this.$aj[t]))
      )
    },
    $ai: function (t) {
      var e
    ...
    $av: function () {
      var t
      for (clearTimeout(this.$aw), this.$aw = null; (t = this.$ak.pop()); )
        this.$ar(t, 'err')
      return this
    },
    _lg: function (t, e, r, n) {
      ...
      if (util_1.$a5(o, c) || util_1.$a5(util_1.decode(o), c)) return this
      if (
        'error' === t &&
        (util_1.$a5(e.msg, s) || util_1.$a5(util_1.decode(e.msg), s))
      )
        return this
      if (
        'resourceError' === t &&
        (util_1.$a5(e.src, u) || util_1.$a5(util_1.decode(e.src), u))
      )
        return this
      if (
        'api' === t &&
        (util_1.$a5(e.api, f) || util_1.$a5(util_1.decode(e.api), f))
      )
        return this
      if (!this.$ao(i.imgUrl)) return this
      if (!e || i.disabled || !i.pid) return this
      if (0 === n) return this
      var l = e.dl
      return (
        delete e.dl,
      ...
      e = util_1.ext(
        {
          t: t,
          times: 1,
          page: util_1.selfErrPage,
          tag: i.pid,
          begin: Date.now(),
        },
        e,
        { pid: selfId, _v: n.ver, sampling: r || 1, z: util_1.seq() }
      )
      var o = n.$ak[0]
      if (o) {
        o.times++
        try {
          if (o.err && e.err && o.err.msg_raw && e.err.msg_raw) {
            o.err.msg_raw.split('&').indexOf(e.err.msg_raw) < 0 &&
              o.err.msg_raw.length < 1e3 &&
              (o.err.msg_raw += '&' + e.err.msg_raw)
          }
        } catch (a) {}
      } else
        n.$ak.unshift(e),
    ...
    custom: function (t, e) {
      ...
      return (
        util_1.each(t, function (t, e) {
          return (
            !(r = e && e.length <= 20) &&
              util_1.warn('[retcode] invalid key: ' + e),
            (n['x-' + e] = t),
            r
          )
        }),
...
var base = Base,
  ...
  parseStatData = function (t) {
    ...
    return e.length > 1
      ? util_1.ext(t, { group: e[0], key: e[1] })
      : util_1.ext(t, { group: 'default_group', key: e[0] })
  },
  Reporter = function (t) {
    base.call(this, t)
    var e
  ...
  util_1.ext(Reporter.prototype, {
    ...
    percent: function (t, e, r, n) {
      try {
        return this._lg(
          'percent',
          parseStatData({ key: t, subkey: e, val: r || 0, begin: Date.now() }),
          n
        )
      } catch (i) {
        util_1.warn('[retcode] can not get parseStatData: ' + i)
    ...
    error: function (t, e) {
      ...
      if (util_1.$ac(n, e.filename)) {
        var a = /^Script error\.?$/,
          s = t.msg || t.message
        if (util_1.$a5(s, a) || util_1.$a5(util_1.decode(s), a)) return this
        var u = {
          msg: util_1.selfErrKey,
          err: { msg_raw: util_1.encode(t.msg || t.message) },
        }
      ...
      var p = (this.getConfig('ignore') || {}).ignoreErrors
      return util_1.$a5(c.msg, p) || util_1.$a5(util_1.decode(c.msg), p)
        ? this
        : (this.$az && this.$az('error', c), this._lg('error', c, 1))
    },
    behavior: function (t) {
      if (t) {
    ...
    api: function (t, e, r, n, i, o, a, s, u, c, f, l) {
      ...
      return util_1.$a5(t.api, p) || util_1.$a5(util_1.decode(t.api), p)
        ? this
        : (this.$az && this.$az('api', t),
          this._lg('api', t, t.success && this.getConfig('sample'), t.flag))
    },
    ...
    performance: function (t) {
      if (t && 'object' == typeof t && !this.$b0) {
        ...
        for (var i in t)
          (/^t([1-9]|1[0])$/.test(i) || 'ctti' === i || 'cfpt' === i) &&
            (e[i] = t[i])
        if (!0 === t.autoSend || (!n && (n || this.$b1)))
          return !0 !== t.autoSend && !1 === n && this.$b1
            ? ((e = util_1.ext(this.$b1 || {}, e)),
              (this.$b0 = !0),
              this._lg('perf', e, this.getConfig('sample')))
            : void 0
    ...
    resource: function (t, e) {
      if (!t || !util_1.isPlainObject(t))
        return util_1.warn('[arms] invalid param data: ' + t), this
      var r = Object.keys(t),
    ...
    event: function (t, e) {
      if ('object' == typeof t && t && t.key) {
        ...
        ;(r.success = !1 === t.success ? 0 : 1), this._lg('event', r, e)
      }
    },
  }),
...
var reporter = Reporter,
  MiniProgramLogger = function (t) {
    ;(t && t.pid) ||
      util_1.warn(
        '[arms] pid is a required prop to instatiate MiniProgramLogger'
      )
    var e = this
    return (
      reporter.call(e, t),
      ...
      (e.$az = function (t, r) {
        'error' === t
          ? e._health.errcount++
          : 'api' === t && e._health[r.success ? 'apisucc' : 'apifail']++
      }),
...
;(MiniProgramLogger.prototype = util_1.$a2(reporter.prototype)),
  ...
  util_1.ext(MiniProgramLogger.prototype, {
    ...
    $ap: function (t, e) {
      if (this.getConfig('debug'))
        'undefined' != typeof console &&
          ...
          console.log('[arms] [DEBUG MODE] log data', t)
      else {
    ...
    $am: function () {
      var t = this._conf.page
      if ('string' == typeof t && t) return util_1.$a3(t, [], t + '')
      ...
      if ('function' == typeof e)
        try {
          ...
          util_1.warn('[arms] error in $am', n)
        }
    ...
    setConfig: function (t) {
      if (t && 'object' == typeof t) {
        ...
        r in t &&
          e[r] !== t[r] &&
          (t[r]
            ? 'function' == typeof this.removeHook && this.removeHook()
            : 'function' == typeof this.addHook && this.addHook())
      }
    },
    appLaunch: function () {
      ...
      var e = this,
        r = {
          ...
          onError: function (r) {
            ...
            try {
              e.error(r),
                e.getConfig('behavior') &&
                  'function' == typeof e.reportBehavior &&
                  e.reportBehavior()
            } catch (r) {
...
;(MiniProgramLogger.createExtraInstance = function (t) {
  t && 'object' == typeof t
    ? ((t.disableHook = !0), (t.behavior = !1))
    : (t = { disableHook: !0, behavior: !1 })
...
var miniProgramLogger = MiniProgramLogger,
                      ...
                      if (r && 'object' == typeof r && r[0]) {
                        ...
                        if (t.getConfig('enableLinkTrace')) {
                          ...
                          if (
                            ...
                            i ||
                              ((i = t.getTraceId()['EagleEye-TraceID']),
                              (l['EagleEye-TraceID'] = i)),
                            o ||
                              ((o = t.getPageviewId()['EagleEye-SessionID']),
                              (l['EagleEye-SessionID'] = o)),
                            !g)
                          ) {
                  ...
                  for (var o in wx)
                    if (i[o]) {
                      ...
                      n[a] = function () {
                        return (
                          i[a](arguments),
                          r[a].apply(r, [].slice.call(arguments))
                        )
                      }
                    } else n[o] = r[o]
                  wx = n
        ...
        consoleBehavior: function () {
          if (console) {
            var t = ['debug', 'info', 'warn', 'log', 'error'],
              e = null
            if (
              (Function && (e = Function.prototype.apply || Function.apply),
              'function' == typeof e)
            )
                ...
                'function' == typeof console[o] &&
                  r(console, o, function (t) {
                    ...
                    return function () {
                      ...
                      var s = {
                        type: 'console',
                        data: { level: r, message: o },
                      }
                      n &&
                        'function' == typeof n.addBehavior &&
                        n.addBehavior(s),
                        'function' == typeof t && e.call(t, console, o)
                    }
                  })
              }
          }
      ...
      util_1.ext(t.prototype, {
        addBehavior: function (t) {
          if (this.getConfig('behavior') && t && 'object' == typeof t) {
            var r = ''
            this._conf &&
              'function' == typeof this._conf.getCurrentPage &&
              (r = this._conf.getCurrentPage())
            var n = null
            try {
              n = Date.now()
            } catch (s) {
            ...
            if (t.type) i = o
              ...
              if ('string' != typeof o.name || 'string' != typeof o.message)
                return
              ;(i.name = o.name.substr(0, 20)),
                (i.message = o.message.substr(0, 200))
            }
        ...
        reportBehavior: function () {
          ...
          t.getConfig('behavior') &&
            (t.$bd && (clearTimeout(t.$bd), (t.$bd = undefined)),
            (t.$bd = setTimeout(function () {
              e &&
                e.length > 0 &&
                ('function' == typeof t.behavior && t.behavior(e), (e = []))
            }, 0)))
        },
        $b3: function () {},
      }),
          ...
          if (t && r) {
            ...
            e[n] && (clearTimeout(e[n]), (e[n] = undefined)),
              (e[n] = setTimeout(function () {
                'function' == typeof e.addBehavior &&
                  e.addBehavior({ type: 'ui.default', data: { level: t } })
              }, 100))
          }
        }
      },
    ...
    util_1.ext(t.prototype, {
      $b3: function () {
        if (!this.hasInitBehavior && !r && void 0 !== e && e) {
          try {
            this.getConfig('enableConsole') &&
              'function' == typeof o.consoleBehavior &&
              o.consoleBehavior.call(this),
              e &&
                ('function' == typeof e.onKeyboardHeightChange &&
                  e.onKeyboardHeightChange(i('KeyboardHeightChange')),
                'function' == typeof e.onPageNotFound &&
                  e.onPageNotFound(i('PageNotFound')),
              ...
              e &&
                ...
                e.onAppRoute(function (t) {
                  ...
                  r && 'function' == typeof r.addBehavior && r.addBehavior(e),
                    (n = (t && t.path) || '')
                }),
              e &&
                'function' == typeof e.onError &&
                e.onError(this.reportBehavior.bind(this))
          } catch (t) {
  ...
  WXLogger = function (t) {
    return miniProgramLogger.call(this, t), this.$be(), this
  }
;(WXLogger.prototype = util_1.$a2(miniProgramLogger.prototype)),
  ...
  util_1.ext(WXLogger.prototype, {
    ...
    $b4: function () {
      this.setCommonInfo({ app: 'mini_wx' }),
        this.$bf(),
        this.$bg(),
        this.$bh(),
        this.$b8()
    ...
    $bh: function () {
      if (this._conf && this._conf.uid)
        this.setCommonInfo({ uid: this._conf.uid })
      else if (
        'undefined' != typeof wx &&
        wx &&
        ...
        try {
          ...
          if (t && 'string' == typeof t) this.setCommonInfo({ uid: t })
            ...
            var e = util_1.uu()
            wx.setStorageSync(ARMS_STORAGE_MINIPROGRAM_WX_UID_KEY, e),
              this.setCommonInfo({ uid: e })
          }
        } catch (r) {
          util_1.warn('[arms] error in $bh', r)
        }
    },
    $bf: function () {
      if (
        ...
        try {
          ...
          util_1.warn('[arms] error in $bf', e)
        }
    },
    $bg: function () {
      var t = this
      if (
        'undefined' != typeof wx &&
        wx &&
        'function' == typeof wx.getNetworkType
      )
        try {
          wx.getNetworkType({
            success: function (e) {
              e &&
                ...
                t.setCommonInfo({ ct: e.networkType })
            },
            fail: function (t) {
              util_1.warn('[arms] $bg getNetworkType fail', t)
            },
          })
        } catch (e) {
          util_1.warn('[arms] error in $bg', e)
        }
    },
    $be: function () {
      var t = this
      if (
        'object' == typeof wx &&
        wx &&
        'function' == typeof wx.getPerformance
      ) {
        t.$b9 = function () {}
        try {
          wx.getPerformance()
            ...
            .observe({ entryTypes: ['navigation', 'render'] })
        } catch (e) {
          util_1.warn('[ARMS] $be error :', e)
        }
      }
    },
    hookApp: function (t) {
          ...
          onError: function (r) {
            ...
            try {
              if (
                ...
                o.length > 1 &&
                  ((a =
                    o[0] && o[0].length < 100 ? o[0] : o[0].substring(0, 100)),
                  (s = o[1])),
